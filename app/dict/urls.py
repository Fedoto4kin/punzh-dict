...
urlpatterns = [
    path(
        "about/",
        views.StaticView.as_view(template_name="staticPages/about.html"),
        name="about",
    ),
    path(
        "intro/",
        views.StaticView.as_view(template_name="staticPages/intro.html"),
        name="intro",
    ),
    path(
        "punzhina/",
        views.StaticView.as_view(template_name="staticPages/punzh.html"),
        name="punzh",
    ),
    path(
        "dialects/",
        views.StaticView.as_view(template_name="staticPages/dialects.html"),
        name="dialects",
    ),
    path(
        "team/",
        views.StaticView.as_view(template_name="staticPages/team.html"),
        name="team",
    ),
