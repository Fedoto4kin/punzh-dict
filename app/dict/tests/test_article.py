...
class ArticleTestCase(TestCase):
    ...
    def test_generate_vars_eule_with_norm(self):
        ...
        test_set = set(i.word for i in indx)
        self.assertSetEqual({"ewle", "eule", "evle"}, test_set)
    ...
    def test_generate_vars_hyvin_with_norm(self):
        ...
        self.assertSetEqual({"hyvin", "hyviin", "hüviin", "hüvin"}, test_set)
    ...
    def test_generate_vars_tuuli_with_norm(self):
        ...
        self.assertSetEqual(
            {"tuuli", "tuulut", "tuwli", "tuvli", "tuwlut", "tuvlut"}, testset
        )
