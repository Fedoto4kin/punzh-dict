...
class KrlHelpersTestCase(TestCase):
    ...
    def test_ngram_1(self):
        self.assertEqual("yö", create_ngram("yö, yöhyt", 3))

    def test_ngram_2(self):
        self.assertEqual("tuu", create_ngram("tuwl’||i, ~ut", 3))

    def test_normalization_1(self):
        self.assertEqual("myödätuuli", normalization("müöd’ä|tuwl’i"))

    def test_normalization_2(self):
        self.assertEqual("olgupiäluu", normalization("olgu|piä|luw"))

    def test_normailization_3(self):
        self.assertEqual("leyhendeliečie", normalization("l’ewhend’el’iečie"))
    ...
    def test_normalization_5(self):
        self.assertEqual(
            "vuate, vuatehut, vi̮ate", normalization("vuat||e, ~ehut, vi̮ate")
        )
    ...
    def test_get_variants_ves1(self):
        self.assertEqual(gen_word_variants("a˛i̮a"), {"aia", "ai̮a"})

    def test_get_variants_ves2(self):
        self.assertEqual(gen_word_variants("mi̮ajäičä I"), {"mi̮ajäicä", "miajäicä"})

    def test_get_variants_normal(self):
        self.assertEqual(gen_word_variants("muš||ta, ~tan’e"), {"musta", "mustane"})
    ...
    def test_get_variants_complex1(self):
        self.assertEqual(
            ...
            {"jukkopuv", "jukko", "puw", "puv", "jukkopuw", "jukkopuu", "puu"},
        )
    ...
    def test_get_variants_complex3(self):
        self.assertEqual(
            ...
            {"armas", "mieli", "aigomane", "armasmieliaigomane"},
        )
    ...
    def test_get_variants_complex_brackets(self):
        self.assertEqual(
            ...
            {"unimielissäh", "uni", "unimielissä", "mielissä", "mielissäh"},
        )
    ...
    def test_get_variants_simple_w1(self):
        self.assertEqual(gen_word_variants("piwš||ta"), {"piwsta", "pivsta", "piusta"})

    def test_get_variants_simple_w2(self):
        self.assertEqual(gen_word_variants("n’ew||guo"), {"newguo", "nevguo", "neuguo"})

    def test_gen_variants_with_parentheses(self):
        self.assertEqual(
            gen_word_variants("kahistun(nun)"), {"kahistun", "kahistunnun"}
        )
